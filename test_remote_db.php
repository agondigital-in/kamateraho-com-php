...
if ($pdo === null) {
    ...
    echo "<p>Make sure:</p>";
    echo "<ul>";
    echo "<li>The remote database server is accessible</li>";
    echo "<li>The database credentials in .env are correct</li>";
    echo "<li>The database 'kamateraho' exists on the remote server</li>";
    echo "<li>Your server can connect to the remote database (firewall settings)</li>";
    echo "</ul>";
} else {
