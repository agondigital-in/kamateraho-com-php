<?php
// Test script to verify purchase request rejection fix
...
if (isset($_POST['test_fix'])) {
    try {
        ...
        if ($request) {
            $message .= "<h3>Processing Rejection for Request ID: " . $request_id . "</h3>";
            ...
            $message .= "<p>Is Purchase Request: " . ($is_purchase_request ? 'Yes' : 'No') . "</p>";
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                ...
                <div class="mt-4">
                    ...
                    <h3>Fix Details:</h3>
                    <ul>
                        <li>Improved the purchase request identification logic</li>
                        <li>Enhanced wallet history query with both LIKE and exact matching</li>
