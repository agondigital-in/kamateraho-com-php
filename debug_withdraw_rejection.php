<?php
// Debug script to check withdrawal request rejection functionality
        ...
        try {
            ...
            if ($request) {
                ...
                if (strpos($request['upi_id'], 'purchase@') === 0) {
                    ...
                    $message .= "Wallet history rows updated for purchase request: " . $rows_affected . "<br>";
...
<head>
    ...
    <title>Debug Withdrawal Request Rejection</title>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <h1 class="mb-4">Debug Withdrawal Request Rejection</h1>
                ...
                <div class="mt-4">
                    <h3>How to Use:</h3>
                    <ol>
                        <li>Find a pending withdrawal request in the admin panel</li>
                    ...
                    <p>The issue appears to be with the exact matching of the description field in the wallet history update query. The fix uses a more flexible LIKE operator to match the description.</p>
                </div>
            </div>
        </div>
    </div>
